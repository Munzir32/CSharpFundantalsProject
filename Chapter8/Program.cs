...
// 2. 
Console.WriteLine("onvert the number 1111010110011110(2) to hexadecimal and decimal numeral systems.");
...
string BinaryResult = Convert.ToString(Convert.ToInt32(HexaToBinary, 2), 16);
...
// 
Console.WriteLine("12. Write a program that converts Arabic digits to Roman ones. ");
...
.
Console.WriteLine("Write a program that by given N, S, D (2 ≤ S, D ≤ 16) converts the number N from an S-based numeral system to a D based numeral system  ");
